...
//                     Not directly referenced (downside)
//                     Less syntax. No need for unique names. (benifit)
...
// console.log(card1.value + card1.suit); //object
// console.log(cards[0].value + cards[0].suit); // array
